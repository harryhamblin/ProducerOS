...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      project_rate_card_items: {
        Row: {
          daily_rate: number
          id: string
          project_rate_card_id: string
          task_id: number
        }
        Insert: {
          daily_rate: number
        ...
        Relationships: [
          {
            foreignKeyName: "project_rate_card_items_project_rate_card_id_fkey"
            columns: ["project_rate_card_id"]
            isOneToOne: false
            referencedRelation: "project_rate_cards"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "project_rate_card_items_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "tasks"
            referencedColumns: ["id"]
      ...
      project_rate_cards: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_rate_cards_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
